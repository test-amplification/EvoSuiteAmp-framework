...
public abstract class GeneticAlgorithm<T extends Chromosome<T>> implements SearchAlgorithm,
    ...
    protected List<muDistanceAnalysis> muDistanceAnalysisPopulation = new ArrayList<>();
    ...
    @Override
    public abstract void generateSolution(List<muDistanceAnalysis> muDistanceAnalysis);
